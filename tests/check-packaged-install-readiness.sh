...
"$INSTALL_ROOT/usr/share/wyrelog/tools/verify-template-release.sh" \
  ...
  0 c5d05ebe7b639d0a582b83f6dda1f6f380d4e17aa4a44d87e9837bdedb7c0f14 \
  1 0 >"$TMPDIR/template-release.out"
if [ "$(cat "$TMPDIR/template-release.out")" != \
    "status=verified version=0 sha256=c5d05ebe7b639d0a582b83f6dda1f6f380d4e17aa4a44d87e9837bdedb7c0f14 migrations=1 latest_migration_version=0" ]; then
