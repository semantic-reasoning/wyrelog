...
check_golden_trace (void)
{
  ...
  static const step_case_t cases[] = {
    ...
    /* negative: logout has no out-edge from locked (unlock is the only
     * exit) or from the terminal revoked state. */
    {WYL_PRINCIPAL_STATE_LOCKED, WYL_PRINCIPAL_EVENT_LOGOUT,
        WYRELOG_E_POLICY, WYL_PRINCIPAL_STATE_LOCKED /* unused */ },
    {WYL_PRINCIPAL_STATE_REVOKED, WYL_PRINCIPAL_EVENT_LOGOUT,
        WYRELOG_E_POLICY, WYL_PRINCIPAL_STATE_REVOKED /* unused */ },
  };
