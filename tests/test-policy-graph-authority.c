...
test_graph_quota_reservation_survives_reopen (void)
{
  ...
  /* Make the retry root available before reopening the policy store.  Binding
   * it explicitly makes the wrong-root rejection below independent of whether
   * a platform resolver happens to register a legacy row during recovery. */
