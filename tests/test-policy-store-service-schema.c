...
static void
test_handoff_terminal_schema_contracts (void)
{
  g_autoptr (wyl_policy_store_t) store = NULL;
  g_assert_cmpint (wyl_policy_store_open (NULL, &store), ==, WYRELOG_E_OK);
  g_assert_cmpint (wyl_policy_store_create_schema (store), ==, WYRELOG_E_OK);
  ...
  exec_ok (db,
      ...
      " successor_issuance_generation,actor_subject_id,reason,outcome,"
      " audit_id,created_at_us) VALUES"
      " ('00000000-0000-7000-8000-000000000001',zeroblob(32),"
      " '0ujtsYcgvSTl8PAuAdqWYSMnLOv',"
      " '00000000-0000-7000-8000-000000000002',zeroblob(32),NULL,NULL,"
      " 'operator','not_committed','terminal_not_committed',"
      " '00000000-0000-7000-8000-000000000003',1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_dispositions"
      " (disposition_id,semantic_key,original_request_id,escrow_id,"
      " binding_digest,successor_credential_id,"
      " successor_issuance_generation,actor_subject_id,reason,outcome,"
      " audit_id,created_at_us) VALUES"
      " ('00000000-0000-7000-8000-000000000004',randomblob(32),"
      " '0ujtsYcgvSTl8PAuAdqWYSMnLOv',"
      " '00000000-0000-7000-8000-000000000002',zeroblob(32),NULL,NULL,"
      " 'other-operator','not_committed','terminal_not_committed',"
      " '00000000-0000-7000-8000-000000000005',2);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_dispositions"
      " (disposition_id,semantic_key,original_request_id,escrow_id,"
      " binding_digest,successor_credential_id,"
      " successor_issuance_generation,actor_subject_id,reason,outcome,"
      " audit_id,created_at_us) VALUES"
      " ('00000000-0000-7000-8000-000000000006',randomblob(32),"
      " '000000000000000000000000000',"
      " '00000000-0000-7000-8000-000000000007',zeroblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'operator','not_committed',"
      " 'terminal_not_committed','00000000-0000-7000-8000-000000000008',1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_dispositions"
      " (disposition_id,semantic_key,original_request_id,escrow_id,"
      " binding_digest,successor_credential_id,"
      " successor_issuance_generation,actor_subject_id,reason,outcome,"
      " audit_id,created_at_us) VALUES"
      " ('00000000-0000-7000-8000-000000000009',randomblob(32),"
      " '000000000000000000000000001',"
      " '00000000-0000-7000-8000-000000000010',zeroblob(31),NULL,NULL,"
      " 'operator','not_committed','terminal_not_committed',"
      " '00000000-0000-7000-8000-000000000011',1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_dispositions"
      " (disposition_id,semantic_key,original_request_id,escrow_id,"
      " binding_digest,successor_credential_id,"
      " successor_issuance_generation,actor_subject_id,reason,outcome,"
      " audit_id,created_at_us) VALUES"
      " ('00000000-0000-7000-8000-000000000018',randomblob(32),"
      " '000000000000000000000000007',"
      " '00000000-0000-7000-8000-000000000019',zeroblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'operator',"
      " 'operation_expired','attention_required',"
      " '00000000-0000-7000-8000-000000000020',1);");
  ...
  exec_ok (db,
      ...
      " oar_source_state,oar_cause,resume_target_state,escrow_id,binding_digest,"
      ...
      " revoke_event_created_at_us,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000001',randomblob(32),randomblob(32),"
      " '000000000000000000000000002','0ujtsYcgvSTl8PAuAdqWYSMnLOv',"
      " 'original-operator','current-operator','operator_action_required',"
      " randomblob(32),'operator_action_required',NULL,NULL,NULL,"
      " 'publication_prepared','explicit_hold','publication_prepared',"
      " '00000000-0000-7000-8000-000000000012',randomblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'resume',0,0,'recorded',"
      " 'retained',1,NULL,NULL,NULL,NULL,NULL,"
      " '00000000-0000-7000-8000-000000000013',1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_remediation_actions"
      " (remediation_request_id,request_fingerprint,incident_fingerprint,"
      " decision_request_id,"
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000003',randomblob(32),randomblob(32),"
      " '000000000000000000000000004','0ujtsYcgvSTl8PAuAdqWYSMnLOv',"
      " 'original-operator','current-operator','operator_action_required',"
      " randomblob(32),'operator_action_required',NULL,NULL,NULL,"
      " 'publication_prepared','explicit_hold','publication_prepared',"
      " '00000000-0000-7000-8000-000000000014',randomblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'resume',1,1,'recorded',"
      " 'retained',1,NULL,NULL,NULL,NULL,NULL,"
      " '00000000-0000-7000-8000-000000000015',1);");
  exec_ok (db,
      "INSERT INTO service_credential_handoff_remediation_actions"
      " (remediation_request_id,request_fingerprint,incident_fingerprint,"
      " decision_request_id,"
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000005',randomblob(32),randomblob(32),"
      " '000000000000000000000000006','0ujtsYcgvSTl8PAuAdqWYSMnLOv',"
      " 'original-operator','current-operator','operator_action_required',"
      " randomblob(32),'operator_action_required',NULL,NULL,NULL,"
      " 'publication_prepared','explicit_hold','publication_prepared',"
      " '00000000-0000-7000-8000-000000000016',randomblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'revoke_and_wipe',1,1,"
      " 'revoked_and_wiped','deleted',2,1,2,"
      " '000000000000000000000000005','current-operator',1,"
      " '00000000-0000-7000-8000-000000000017',1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_remediation_actions"
      " (remediation_request_id,request_fingerprint,incident_fingerprint,"
      " decision_request_id,"
      ...
      " SELECT '000000000000000000000000008',randomblob(32),randomblob(32),"
      " decision_request_id,original_request_id,original_actor_subject_id,"
      " current_actor_subject_id,source_kind,randomblob(32),observed_state,"
      ...
      " credential_generation_after,revoke_event_id,revoke_event_generation,"
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,"
      " '00000000-0000-7000-8000-000000000021',created_at_us FROM"
      " service_credential_handoff_remediation_actions"
      " WHERE remediation_request_id='000000000000000000000000001';");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_remediation_actions"
      " (remediation_request_id,request_fingerprint,incident_fingerprint,"
      " decision_request_id,"
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us)"
      " SELECT '000000000000000000000000009',randomblob(32),randomblob(32),"
      " '000000000000000000000000010',original_request_id,"
      " original_actor_subject_id,current_actor_subject_id,source_kind,"
      " randomblob(32),observed_state,source_disposition_id,source_audit_id,"
      " source_reason,oar_source_state,oar_cause,resume_target_state,escrow_id,"
      " binding_digest,successor_credential_id,"
      " successor_issuance_generation,action,confirmation_version,confirmed,"
      " outcome,escrow_outcome,credential_generation_after,revoke_event_id,"
      " revoke_event_generation,revoke_event_request_id,"
      " revoke_event_actor_subject_id,revoke_event_created_at_us,"
      " audit_id,created_at_us FROM"
      " service_credential_handoff_remediation_actions"
      " WHERE remediation_request_id='000000000000000000000000001';");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_remediation_actions"
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us)"
      " SELECT '000000000000000000000000011',randomblob(32),randomblob(32),"
      " '000000000000000000000000012',original_request_id,"
      " original_actor_subject_id,current_actor_subject_id,source_kind,"
      " randomblob(32),observed_state,source_disposition_id,source_audit_id,"
      " source_reason,oar_source_state,oar_cause,resume_target_state,escrow_id,"
      " binding_digest,successor_credential_id,"
      ...
      " revoke_event_generation,revoke_event_request_id,"
      " revoke_event_actor_subject_id,revoke_event_created_at_us,"
      " '00000000-0000-7000-8000-000000000022',created_at_us FROM"
      " service_credential_handoff_remediation_actions"
      " WHERE remediation_request_id='000000000000000000000000005';");
  exec_rejected (db,
      "UPDATE service_credential_handoff_dispositions SET created_at_us=2;");
  exec_rejected (db,
      "DELETE FROM service_credential_handoff_remediation_actions;");
  exec_rejected (db,
      "INSERT INTO service_domain_requests"
      " (request_id,operation,resource_id,input_fingerprint,created_at_us)"
      " VALUES('000000000000000000000000001','credential_revoke',"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',zeroblob(32),1);");
  exec_ok (db,
      "INSERT INTO service_domain_requests"
      " (request_id,operation,resource_id,input_fingerprint,created_at_us)"
      " VALUES('000000000000000000000000020','credential_revoke',"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',zeroblob(32),1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_remediation_actions"
      " (remediation_request_id,request_fingerprint,incident_fingerprint,"
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000020',randomblob(32),randomblob(32),"
      " '000000000000000000000000021','000000000000000000000000022',"
      " 'original-operator','current-operator','operator_action_required',"
      " randomblob(32),'operator_action_required',NULL,NULL,NULL,"
      " 'publication_prepared','explicit_hold','publication_prepared',"
      " '00000000-0000-7000-8000-000000000023',randomblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'resume',0,0,'recorded',"
      " 'retained',1,NULL,NULL,NULL,NULL,NULL,"
      " '00000000-0000-7000-8000-000000000024',1);");
  g_assert_cmpint (wyl_policy_store_validate_service_schema (store), ==,
      WYRELOG_E_OK);
}
...
test_handoff_cancellation_schema_contracts (void)
{
  ...
  exec_ok (db,
      ...
      " original_request_id,original_actor_subject_id,"
      " current_actor_subject_id,resolution,escrow_id,binding_digest,"
      " successor_credential_id,successor_issuance_generation,operation,"
      " target_a,target_b,target_digest,maintenance_proof_digest,"
      " deadline_at_us,disposition_id,"
      " audit_id,created_at_us) VALUES"
      " ('000000000000000000000000030',zeroblob(32),"
      " '000000000000000000000000031','000000000000000000000000032',"
      " 'original-operator','current-operator','committed_attention',"
      " '00000000-0000-7000-8000-000000000030',randomblob(32),"
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'issue',"
      " 'svc:tenant-a:worker','tenant-a',randomblob(32),randomblob(32),100,"
  ...
  exec_ok (db,
      ...
      " successor_credential_id,successor_issuance_generation,operation,"
      " target_a,target_b,target_digest,maintenance_proof_digest,"
      " deadline_at_us,disposition_id,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000070',zeroblob(32),"
      " '000000000000000000000000071','000000000000000000000000072',"
      " 'original-operator','current-operator','terminal_not_committed',"
      " '00000000-0000-7000-8000-000000000070',zeroblob(32),NULL,NULL,"
      " 'rotate','wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',NULL,randomblob(32),"
      " randomblob(32),100,'00000000-0000-7000-8000-000000000071',"
      " '00000000-0000-7000-8000-000000000072',1);");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_cancellation_claims"
      " SELECT '000000000000000000000000073',request_fingerprint,"
      " '000000000000000000000000074','000000000000000000000000075',"
      " original_actor_subject_id,current_actor_subject_id,"
      " 'terminal_not_committed','00000000-0000-7000-8000-000000000073',"
      ...
      " deadline_at_us,'00000000-0000-7000-8000-000000000074',"
      " '00000000-0000-7000-8000-000000000075',created_at_us"
      " FROM service_credential_handoff_cancellation_claims"
      " WHERE cancellation_request_id='000000000000000000000000030';");
  exec_rejected (db,
      "INSERT INTO service_credential_handoff_cancellation_claims"
      " SELECT '000000000000000000000000076',request_fingerprint,"
      " '000000000000000000000000077','000000000000000000000000078',"
      " original_actor_subject_id,current_actor_subject_id,"
      " 'committed_attention','00000000-0000-7000-8000-000000000076',"
      " binding_digest,successor_credential_id,successor_issuance_generation,"
      " operation,target_a,target_b,target_digest,maintenance_proof_digest,"
      " deadline_at_us,'00000000-0000-7000-8000-000000000077',"
      " '00000000-0000-7000-8000-000000000078',created_at_us"
      " FROM service_credential_handoff_cancellation_claims"
      " WHERE cancellation_request_id='000000000000000000000000070';");
  exec_rejected (db,
  ...
  exec_rejected (db,
      ...
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv',1,'issue',"
      " 'svc:tenant-a:worker',NULL,randomblob(32),randomblob(32),100,"
  ...
  exec_rejected (db,
      ...
      " 'wlc_0ujtsYcgvSTl8PAuAdqWYSMnLOv','tenant-a',randomblob(32),"
      " randomblob(32),100,"
  ...
  exec_rejected (db,
      ...
      " 'same-operator','same-operator','committed_attention',"
  ...
  exec_rejected (db,
      ...
      " original_actor_subject_id,current_actor_subject_id,"
      " resolution,'00000000-0000-7000-8000-000000000050',randomblob(32),"
      " successor_credential_id,2,operation,target_a,target_b,"
      " target_digest,maintenance_proof_digest,deadline_at_us,"
  ...
  exec_rejected (db,
      ...
      " original_actor_subject_id,current_actor_subject_id,"
      " resolution,'00000000-0000-7000-8000-000000000052',randomblob(32),"
      " successor_credential_id,2,operation,target_a,target_b,target_digest,"
      " maintenance_proof_digest,deadline_at_us,"
  ...
  exec_rejected (db,
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000030',randomblob(32),randomblob(32),"
  ...
  exec_rejected (db,
      ...
      " original_actor_subject_id,current_actor_subject_id,"
      " resolution,'00000000-0000-7000-8000-000000000056',randomblob(32),"
      " successor_credential_id,2,operation,target_a,target_b,target_digest,"
      " maintenance_proof_digest,deadline_at_us,"
  ...
  exec_ok (db,
      ...
      " revoke_event_request_id,revoke_event_actor_subject_id,"
      " revoke_event_created_at_us,audit_id,created_at_us) VALUES"
      " ('000000000000000000000000059',randomblob(32),randomblob(32),"
  ...
  exec_rejected (db,
      ...
      " original_actor_subject_id,current_actor_subject_id,"
      " resolution,'00000000-0000-7000-8000-000000000061',randomblob(32),"
      " successor_credential_id,2,operation,target_a,target_b,target_digest,"
      " maintenance_proof_digest,deadline_at_us,"
...
test_handoff_remediation_legacy_upgrade (void)
{
  ...
  sqlite3 *db = wyl_policy_store_get_db (store);
  exec_ok (db,
      "CREATE TABLE service_domain_requests ("
      ...
      "INSERT INTO service_domain_requests"
      " (request_id,operation,resource_id,input_fingerprint,created_at_us)"
      " VALUES('000000000000000000000000025','credential_revoke',"
      " 'legacy-resource',zeroblob(32),1);");
  g_assert_cmpint (wyl_policy_store_create_schema (store), ==, WYRELOG_E_OK);
  g_assert_cmpint (wyl_policy_store_validate_service_schema (store), ==,
      WYRELOG_E_OK);
  g_assert_cmpint (scalar_int64 (db,
...
test_corruption_matrix (void)
{
  ...
  }
  {
    ...
    g_assert_cmpint (wyl_policy_store_create_schema (store), ==, WYRELOG_E_OK);
    exec_ok (wyl_policy_store_get_db (store),
        "DROP INDEX idx_service_handoff_completed_revoke;"
        "CREATE UNIQUE INDEX idx_service_handoff_completed_revoke ON"
        " service_credential_handoff_remediation_actions("
        " original_request_id,escrow_id,binding_digest,"
        " successor_credential_id,successor_issuance_generation,action)"
        " WHERE action='resume';");
    g_assert_cmpint (wyl_policy_store_validate_service_schema (store), ==,
        WYRELOG_E_POLICY);
  }
  {
    ...
    g_assert_cmpint (wyl_policy_store_create_schema (store), ==, WYRELOG_E_OK);
    exec_ok (wyl_policy_store_get_db (store),
        "DROP INDEX idx_service_handoff_disposition_exact;"
        "CREATE UNIQUE INDEX idx_service_handoff_disposition_exact ON"
        " service_credential_handoff_dispositions(original_request_id,reason,"
        " outcome,escrow_id,binding_digest,"
        " coalesce(successor_credential_id,'x'),"
...
seed_legacy_values (sqlite3 *db)
{
  exec_ok (db,
      ...
      "INSERT OR REPLACE INTO tenants(tenant_id,sealed,created_at,updated_at) "
      "VALUES('__wr_default',0,21,22);"
      ...
      " VALUES('legacy-human','authenticated',71,3,NULL);"
      "INSERT INTO principal_states"
      " VALUES('svc:legacy','authenticated',72,4,NULL);"
