...
EXPECTED_POSIX_DIRECTIVE_PROFILE_SHA256 = (
    "b9edd87a30b3602751e59b00a5abd476f70722226eb8fe6f36e8b13b3b89c6a2"
)
...
EXPECTED_POSIX_LOCK_HEADER_CLOSURE_DIRECTIVE_COUNTS = (
    13, 7, 10, 8, 2, 3, 4, 37, 6, 5,
)
EXPECTED_POSIX_LOCK_HEADER_CLOSURE_DIRECTIVE_PROFILE_SHA256 = (
    "1465b5fa4b2f546bf64a97d905b3460073eafa2e839fdbb6417ea28a4717aa4f"
)
EXPECTED_POSIX_LOCK_HEADER_CLOSURE_SEMANTIC_TOKEN_COUNTS = (
    1326, 70, 65, 98, 99, 474, 501, 965, 120, 315,
)
EXPECTED_POSIX_LOCK_HEADER_CLOSURE_SEMANTIC_TOKEN_PROFILE_SHA256 = (
    "c28371eca7ccbf4ca5c0e8c253a75531fcbac345f3310181af09fd6c28e6346a"
)
...
SECURE_POSIX_ACTIVE_COMMANDS = (
    ...
    "fi | grep -F 'GNU patch'",
    'if [ "$RUNNER_OS" = Linux ]; then',
    "CC=cc CXX=c++ meson setup build-secure-duckdb -Denable_fact_store=enabled -Denable_audit=enabled -Dduckdb_source=subproject -Denable_secure_duckdb_bridge=enabled",
    "else",
    "meson setup build-secure-duckdb -Denable_fact_store=enabled -Denable_audit=enabled -Dduckdb_source=subproject -Denable_secure_duckdb_bridge=enabled",
    "fi",
    'if [ "$RUNNER_OS" = Linux ]; then',
    "time_args=(-v)",
    "else",
