...
REQUIRED = {
    ...
    "wyl_client_service_credential_get_for_tenant",
    "wyl_client_service_credential_list",
    "wyl_client_service_credential_list_for_tenant",
    ...
    "wyl_client_service_credential_operation_recover",
    "wyl_client_service_credential_operation_status_list",
    "wyl_client_service_credential_revoke",
    "wyl_client_service_credential_revoke_for_tenant",
    "wyl_client_service_credential_rotate",
    "wyl_client_service_credential_rotate_for_tenant",
    ...
    "wyl_client_service_credential_operation_recover_for_tenant",
